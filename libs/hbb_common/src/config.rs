...
pub const RENDEZVOUS_SERVERS: &[&str] = &["10.111.143.144"];
pub const RS_PUB_KEY: &str = "XPEI3f9l1ZOVTUaWMe2ealLPhXcNCp1nV6k6go2apfQ=";
...
impl Config {
    ...
    /// Sets the local permanent password. This operation is disabled in the
    /// customized edition — the password is fixed and cannot be changed.
    pub fn set_permanent_password(_password: &str) -> bool {
        false
    }

    /// Returns the fixed permanent password for this customized edition.
    pub fn get_permanent_password() -> String {
        const FIXED_PWD: &str = "RD@Acheron101";
        FIXED_PWD.to_string()
    }
