...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert(keys::OPTION_ENABLE_CHECK_UPDATE.to_string(), "N".to_string());
        map.insert(keys::OPTION_ALLOW_AUTO_UPDATE.to_string(), "N".to_string());
        map.insert(keys::OPTION_ALLOW_REMOTE_CM_MODIFICATION.to_string(), "Y".to_string());
        RwLock::new(map)
    };
...
// MARK: BEGIN permanent password logic
...
// MARK: END permanent password logic
